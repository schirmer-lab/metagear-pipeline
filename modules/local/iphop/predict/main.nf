process IPHOP_PREDICT {
    ...
    if ls iphop_results/Host_prediction_to_*.csv 1>/dev/null 2>&1; then
        ...
        touch ${prefix}.Host_prediction_to_genus_m90.csv
        touch ${prefix}.Host_prediction_to_genome_m90.csv
